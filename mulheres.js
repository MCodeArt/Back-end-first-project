...
const cors = require('cors') // aqui trazendo pacote cors que permite consumir esta API no frontend

const conectaBancoDeDados = require('./bancoDeDados.js') //aqui ligando ao arquivo banco de dados
